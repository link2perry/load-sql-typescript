...
var SqlResultImpl = /** @class */ (function () {
    function SqlResultImpl() {
    }
...
exports.QueryOptionsImpl = QueryOptionsImpl;
var LoadSql = /** @class */ (function () {
    ...
    LoadSql.prototype.loadForMssql = function (file, q) {
        ...
        if (this.sqlCache[file]) {
            ...
            var me = this;
            try {
                var data = fs_1.default.readFileSync(this.sqlDir + file + '.sql');
                var sql = '';
                if (data) {
                    sql = data.toString('utf8');
                }
